          ...
          <Stack gap="lg">
            ...
            <Alert color="brand" icon={<IconCheck size={20} />} radius="md">
              <Text size="md" fw={500}>
                ...
                você pode usar qualquer coisa das camadas de dentro. Se você
                está na camada de dentro, você NUNCA pode usar nada das camadas
                de fora.
              </Text>
            </Alert>
          ...
          <Stack gap="lg">
            ...
            <SimpleGrid cols={{ base: 1, md: 3 }} spacing="lg">
              ...
              <Card withBorder p="md" radius="md" ta="center">
                ...
                <Text size="sm" c="dimmed">
                  Mude uma camada sem afetar as outras. Refatore com segurança,
                  evolua sem medo.
                </Text>
              </Card>
            </SimpleGrid>
          ...
          <Stack gap="lg">
            ...
            <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg">
              <Card withBorder p="md" radius="md">
                ...
                <Text size="sm" c="dimmed">
                  Entidades com métodos de renderização. Domain não deve saber
                  sobre React, Vue ou qualquer framework.
                </Text>
                <Code block mt="md">
                  {`// ❌ ERRADO
class User {
  render() {
    return <div>{this.name}</div>;
              ...
              <Card withBorder p="md" radius="md">
                ...
                <Text size="sm" c="dimmed">
                  Repository usando service. Repository deve ser a camada mais
                  baixa de acesso a dados.
                </Text>
                <Code block mt="md">
                  {`// ❌ ERRADO
          ...
          <Stack gap="lg">
            ...
            <Alert color="brand" icon={<IconBulb size={20} />} radius="md">
              <Text size="md" fw={500}>
                ...
                módulo, depois expanda. É melhor ter uma parte bem arquitetada
                do que tudo quebrado.
              </Text>
            </Alert>
          </Stack>
        </Paper>
          ...
          <Stack gap="lg">
            ...
            <SimpleGrid cols={{ base: 1, md: 3 }} spacing="lg">
              <Card withBorder p="md" radius="md" ta="center">
                ...
                <Text size="sm" c="dimmed">
                  Teste cada camada isoladamente. Mocks simples, testes que
              ...
              <Card withBorder p="md" radius="md" ta="center">
                ...
                <Text size="sm" c="dimmed">
                  Seu negócio não depende de tecnologia. Troque React por Vue,
                  seu core sobrevive.
                </Text>
              </Card>
            </SimpleGrid>
