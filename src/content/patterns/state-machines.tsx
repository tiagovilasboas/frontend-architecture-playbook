    ...
    <Stack gap="xl">
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Estados bem definidos, transições claras. Sem surpresas, sem
                  bugs impossíveis.
                </Text>
              </div>
            </Group>
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Comportamento centralizado, regras claras. Fácil de entender e
                  manter.
                </Text>
              </div>
            </Group>
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Estados isolados, transições testáveis. Cobertura de testes
                  completa.
                </Text>
              </div>
            </Group>
      ...
      <div>
        ...
        <Stack gap="xl">
          ...
          <Paper withBorder p="xl" radius="md">
            <Title order={3} mb="md">
              📝 Formulário - Estados Complexos
            </Title>

            <Stack gap="md">
              <Text>
                <strong>Cenário:</strong> Formulário com validação, envio
                assíncrono, feedback visual. Estados complexos.
                <br />
          ...
          <Paper withBorder p="xl" radius="md">
            ...
            <Stack gap="md">
              <Text>
                ...
                <br />
                <strong>Problema:</strong> Estados de sessão confusos, race
                conditions, bugs de segurança.
              </Text>
          ...
          <Paper withBorder p="xl" radius="md">
            <Title order={3} mb="md">
              📁 Upload de Arquivos - Estados de Progresso
            </Title>
            ...
            <Stack gap="md">
              <Text>
                ...
                <br />
                <strong>Problema:</strong> Estados de upload confusos, progresso
                inconsistente, UX ruim.
              </Text>
        ...
        <Stack gap="xl">
          ...
          <Paper withBorder p="xl" radius="md">
            ...
            <Stack gap="md">
              ...
              <Text>
                <strong>Como evitar:</strong> Use state machines só quando
                estados são complexos. Lógica simples não precisa de state
                machine.
              </Text>
          ...
          <Paper withBorder p="xl" radius="md">
            ...
            <Stack gap="md">
              ...
              <Text>
                <strong>Como evitar:</strong> Mantenha transições simples, use
                guards para condições complexas.
              </Text>
          ...
          <Paper withBorder p="xl" radius="md">
            ...
            <Stack gap="md">
              ...
              <Text>
                <strong>Como evitar:</strong> Agrupe estados relacionados, use
                hierarquia, simplifique.
              </Text>
          ...
          <Paper withBorder p="xl" radius="md">
            ...
            <Stack gap="md">
              <Text>
                <strong>Problema:</strong> Side effects misturados com
                transições, lógica espalhada, difícil de testar.
              </Text>
          ...
          <Paper withBorder p="xl" radius="md">
            ...
            <Stack gap="md">
              ...
              <Text>
                <strong>Como evitar:</strong> Teste cada transição, use
                ferramentas de testing específicas.
              </Text>
          ...
          <Paper withBorder p="xl" radius="md">
            ...
            <Stack gap="md">
              ...
              <List>
                ...
                <List.Item>
                  <strong>"Understanding State Machines"</strong> - Various
                  Authors
                </List.Item>
                <List.Item>
      ...
      <Paper withBorder p="xl" radius="md">
        <Stack gap="md">
          ...
          <Text size="sm" c="dimmed">
            ...
            <br />
            <strong>Dica:</strong> Comece com estados simples, evolua conforme
            necessário. Foque em previsibilidade e simplicidade.
          </Text>
        </Stack>
      </Paper>
    </Stack>
