...
import { IconBulb, IconAlertTriangle, IconCheck, IconCode, IconCopy } from '@tabler/icons-react';
    ...
    <Stack gap="xl">
      ...
      <div>
        ...
        <Text size="lg" c="dimmed">
          Elimine duplicação de código. Se você está escrevendo a mesma coisa duas vezes, 
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Uma mudança em um lugar só. Sem risco de esquecer de atualizar código duplicado.
                </Text>
              </div>
            </Group>
          </Card>
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Funções e componentes reutilizáveis. Menos código, mais funcionalidade.
                </Text>
              </div>
            </Group>
          </Card>
...
Dry.metadata = {
  ...
  description: 'Elimine duplicação de código. Se você está escrevendo a mesma coisa duas vezes, você está fazendo algo errado.'
};
