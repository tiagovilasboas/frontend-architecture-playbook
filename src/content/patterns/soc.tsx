    ...
    <Stack gap="xl">
        ...
        <Stack gap="md">
          <Group>
            ...
            <div>
              ...
              <Text c="dimmed">Princípio que separa diferentes responsabilidades em módulos distintos</Text>
            </div>
          </Group>
          
          <Text>
            SOC significa <strong>"Separation of Concerns"</strong>. É sobre <em>organização mental</em>. 
            Cada parte do seu código deve ter uma preocupação específica.
          </Text>
          
          <Text>
            Pensa assim: se você mistura lógica de negócio com UI, está violando SOC. 
            Se um modelo sabe como é exibido, está violando SOC. Se configuração está hardcoded, está violando SOC.
          </Text>
          
          <Text>
            A regra é clara: <em>cada módulo deve se preocupar com apenas um aspecto do sistema</em>. 
            UI só com apresentação, lógica só com regras, dados só com persistência.
          </Text>
        </Stack>
      </Paper>
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Teste só da lógica de negócio, sem se preocupar com UI ou banco de dados.
                </Text>
              </div>
            </Group>
          </Card>
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Lógica de negócio pode ser usada em diferentes UIs (web, mobile, API).
                </Text>
              </div>
            </Group>
          </Card>
          ...
          <Card withBorder p="md">
            <Group>
              ...
              <div>
                ...
                <Text size="sm">
                  Mudar UI não afeta lógica, mudar lógica não afeta dados, mudar API não afeta nada.
                </Text>
              </div>
            </Group>
          </Card>
      ...
      <Paper withBorder p="xl" radius="md">
        <Stack gap="md">
          ...
          <Text>
            SOC é sobre organização mental. Cada parte do sistema deve ter uma preocupação específica. 
            Se você mistura responsabilidades, está violando SOC.
          </Text>
          <Text>
            <strong>Regra de ouro:</strong> Se você pode dizer "essa classe faz X E Y E Z", 
            você está violando SOC. Cada classe deve fazer apenas uma coisa.
          </Text>
        </Stack>
      </Paper>
    </Stack>
...
SOC.metadata = {
  ...
  description: 'Separe responsabilidades claramente. Cada parte do sistema deve ter uma preocupação específica.'
};
