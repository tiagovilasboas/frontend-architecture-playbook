...
import { IconCheck, IconAlertTriangle, IconBulb, IconRocket, IconApi } from '@tabler/icons-react';
    ...
    <Stack gap="xl">
      ...
      <div>
        <Group gap="sm" mb="md">
          ...
          <div>
            <Title order={1} size="h1">🔌 Backend-for-Frontend (BFF)</Title>
      ...
      <Paper withBorder p="xl" radius="md">
        ...
        <Text size="lg" mb="md">
          Sabe quando você tem 5 APIs diferentes e precisa fazer <Text span fw={700} c="violet">7 requests</Text> pra montar uma tela?{' '}
          BFF é uma camada que <Text span fw={700} c="blue">agrega, transforma e otimiza</Text> dados especificamente pro seu frontend.
        </Text>

        <Text mb="lg">
          É tipo ter um <Text span fw={700}>garçom exclusivo</Text> que conhece exatamente como você gosta do seu pedido,{' '}
          em vez de ir direto na cozinha negociar com 5 chefs diferentes.
        </Text>
      ...
      <Paper withBorder p="xl" radius="md">
        ...
        <Stack gap="md">
          <Card withBorder p="md">
            <Text fw={600} c="orange" mb="sm">🏢 Múltiplas APIs internas</Text>
            <Text>Microservices que não "conversam" bem. Cada um tem sua estrutura, versionamento, formato.</Text>
          </Card>

          <Card withBorder p="md">
            <Text fw={600} c="orange" mb="sm">📱 Mobile vs Desktop</Text>
            <Text>App mobile precisa de dados otimizados. Web desktop quer tudo detalhado. Mesma API não serve.</Text>
          </Card>

          <Card withBorder p="md">
            <Text fw={600} c="orange" mb="sm">🔄 Over/Under-fetching</Text>
            <Text>GraphQL é overkill mas REST genérica traz dados demais ou de menos pro que você precisa.</Text>
          </Card>

          <Card withBorder p="md">
            <Text fw={600} c="orange" mb="sm">🎭 APIs de terceiros</Text>
            <Text>Stripe, PayPal, AWS - cada uma com formato diferente. BFF normaliza tudo.</Text>
          </Card>
        </Stack>
      </Paper>
  ...
  └─────────────┘ └─────────────┘ └─────────────┘ └─────────────┘`}
      ...
      <Paper withBorder p="xl" radius="md">
        ...
        <Stack gap="md">
          <Alert color="green" icon={<IconCheck size={16} />}>
            ...
            <Text size="sm">1 request em vez de 7. Menos latência, menos waterfalls, menos loading states.</Text>
          </Alert>

          <Alert color="green" icon={<IconCheck size={16} />}>
            <Text fw={600} mb="xs">🎯 Dados sob medida</Text>
            <Text size="sm">Mobile recebe 10KB. Desktop recebe 100KB. Cada um o que precisa.</Text>
          </Alert>

          <Alert color="green" icon={<IconCheck size={16} />}>
            <Text fw={600} mb="xs">🔒 Security por design</Text>
            <Text size="sm">Frontend nunca fala direto com APIs críticas. BFF filtra e controla acesso.</Text>
          </Alert>

          <Alert color="green" icon={<IconCheck size={16} />}>
            <Text fw={600} mb="xs">🛠️ Frontend mais limpo</Text>
            <Text size="sm">Menos lógica de integração. Mais foco na UX e menos em transformar dados.</Text>
          </Alert>
        </Stack>
      </Paper>
      ...
      <Paper withBorder p="xl" radius="md">
        <Group gap="sm" mb="md">
          ...
          <Title order={2} size="h2">💻 Exemplo Prático: Dashboard E-commerce</Title>
        </Group>

        <Text mb="md">
          Cenário: Dashboard que mostra <Text span fw={700}>vendas + inventário + reviews</Text> de 3 microservices diferentes.
        </Text>
...
function Dashboard() {
  ...
  return (
    <div>
      ...
      {/* BFF vs Alternativas */}
      <Paper withBorder p="xl" radius="md">
        <Title order={2} size="h2" mb="md">⚖️ BFF vs Alternativas</Title>

        <Group grow align="flex-start" gap="lg">
          <Card withBorder p="md">
            <Badge variant="light" color="red" mb="sm">❌ Direto nas APIs</Badge>
          ...
          <Card withBorder p="md">
            <Badge variant="light" color="orange" mb="sm">⚠️ GraphQL</Badge>
            <List size="sm" spacing={4}>
          ...
          <Card withBorder p="md">
            <Badge variant="light" color="green" mb="sm">✅ BFF</Badge>
            <List size="sm" spacing={4}>
      ...
      <Paper withBorder p="xl" radius="md">
        ...
        <Stack gap="md">
          <Alert color="red" icon={<IconAlertTriangle size={16} />}>
            <Text fw={600} mb="xs">🏗️ Mais infraestrutura</Text>
            <Text size="sm" mb="xs">
              BFF é outro service pra manter. Deploy, monitoring, scaling, logs.
            </Text>
            <Text size="sm" c="dimmed">
              <Text span fw={600}>Solução:</Text> Comece simples (Express + Redis) e evolua conforme necessário.
            </Text>
          </Alert>

          <Alert color="red" icon={<IconAlertTriangle size={16} />}>
            <Text fw={600} mb="xs">🔄 Duplicação de lógica</Text>
            <Text size="sm" mb="xs">
              Regras de negócio podem vazar pro BFF e duplicar com microservices.
            </Text>
            <Text size="sm" c="dimmed">
              <Text span fw={600}>Solução:</Text> BFF só agrega e transforma. Lógica fica nos services.
            </Text>
          </Alert>

          <Alert color="red" icon={<IconAlertTriangle size={16} />}>
            <Text fw={600} mb="xs">📊 Single point of failure</Text>
            <Text size="sm" mb="xs">
              BFF cai = frontend para. Ironicamente, pode reduzir disponibilidade.
            </Text>
            <Text size="sm" c="dimmed">
              <Text span fw={600}>Solução:</Text> Circuit breakers, fallbacks, cache resiliente.
            </Text>
          </Alert>

          <Alert color="red" icon={<IconAlertTriangle size={16} />}>
            <Text fw={600} mb="xs">⏱️ Latência extra</Text>
            <Text size="sm" mb="xs">
              Mais um hop na rede. Frontend → BFF → Services.
            </Text>
            <Text size="sm" c="dimmed">
              <Text span fw={600}>Solução:</Text> Cache agressivo, conexões keep-alive, deploy próximo.
            </Text>
          </Alert>
        </Stack>
      </Paper>
      ...
      <Paper withBorder p="xl" radius="md">
        ...
        <Stack gap="md">
          <Card withBorder p="md">
            <Text fw={600} c="blue" mb="sm">📺 Netflix</Text>
            <Text size="sm" mb="xs">
              <Text span fw={600}>Problema:</Text> 700+ microservices, cada device precisava de dados diferentes
            </Text>
            <Text size="sm" mb="xs">
              <Text span fw={600}>Solução:</Text> BFF específico para TV, mobile, web - cada um otimizado
            </Text>
            <Text size="sm" c="green">
              <Text span fw={600}>Resultado:</Text> -60% requests, +40% performance, UX específica por device
            </Text>
          </Card>

          <Card withBorder p="md">
            <Text fw={600} c="blue" mb="sm">🎵 Spotify</Text>
            <Text size="sm" mb="xs">
              <Text span fw={600}>Problema:</Text> Apps mobile faziam 20+ requests pra montar playlist
            </Text>
            <Text size="sm" mb="xs">
              <Text span fw={600}>Solução:</Text> BFF que agrega músicas + metadata + recommendations
            </Text>
            <Text size="sm" c="green">
              <Text span fw={600}>Resultado:</Text> Tempo de carregamento de playlist: 3s → 500ms
            </Text>
          </Card>

          <Card withBorder p="md">
            <Text fw={600} c="blue" mb="sm">🚗 Uber</Text>
            <Text size="sm" mb="xs">
              <Text span fw={600}>Problema:</Text> Driver app e rider app precisavam de dados similares mas formatados diferente
            </Text>
            <Text size="sm" mb="xs">
              <Text span fw={600}>Solução:</Text> BFF dedicado pra cada app com lógica específica de agregação
            </Text>
            <Text size="sm" c="green">
              <Text span fw={600}>Resultado:</Text> Times independentes, deploy sem conflito, UX otimizada
            </Text>
          </Card>
        </Stack>
      </Paper>
      ...
      {/* Implementação */}
      <Paper withBorder p="xl" radius="md">
        <Title order={2} size="h2" mb="md">🛠️ Stack Recomendado</Title>

        <Group grow align="flex-start" gap="lg">
          <Card withBorder p="md">
            <Badge variant="light" color="blue" mb="sm">Runtime</Badge>
            <List size="sm" spacing={4}>
          ...
          <Card withBorder p="md">
            <Badge variant="light" color="green" mb="sm">Cache</Badge>
            <List size="sm" spacing={4}>
      ...
      <Paper withBorder p="xl" radius="md">
        ...
        <Alert color="violet" icon={<IconBulb size={16} />} radius="md">
          <Text fw={600} size="lg" mb="md" style={{ fontStyle: 'italic' }}>
            "BFF é o garçom que traduz o que você quer pro chef da cozinha - e traz tudo numa bandeja só."
          </Text>
          ...
          <List spacing="sm">
            ...
            <List.Item icon={<IconCheck size={14} color="var(--mantine-color-green-6)" />}>
              <Text>Otimiza requests: 7 viram 1, dados sob medida por frontend</Text>
            </List.Item>
            <List.Item icon={<IconCheck size={14} color="var(--mantine-color-green-6)" />}>
              <Text>Trade-off: performance vs complexidade de infraestrutura</Text>
            </List.Item>
            <List.Item icon={<IconCheck size={14} color="var(--mantine-color-green-6)" />}>
              <Text>Netflix, Spotify, Uber usam - e você deveria considerar</Text>
            </List.Item>
          </List>
        </Alert>
      </Paper>
...
BFFArchitecture.metadata = {
  ...
  description: 'Como criar uma API sob medida pro seu frontend, agregando dados de múltiplos services de forma otimizada.'
};