...
export default function SecurityPatterns() {
  return (
    <Stack gap="xl">
      ...
      <Paper withBorder p="xl">
        <Title order={2} mb="md">
          <IconCode size={24} style={{ marginRight: 8 }} />O que é?
        </Title>
        <Text>
          Security patterns são técnicas e práticas que protegem sua aplicação
          front-end contra vulnerabilidades comuns. Não é sobre virar um expert
          em criptografia, é sobre não deixar brechas de segurança abertas.
        </Text>
      ...
      <Paper withBorder p="xl">
        ...
        <Stack gap="md">
          <Alert color="green" title="Sempre">
            <Text size="sm">
              <strong>Formulários de login/registro</strong> - Validação
              rigorosa de inputs
            </Text>
          </Alert>
          ...
          <Alert color="blue" title="Aplicações com dados sensíveis">
            <Text size="sm">
              <strong>E-commerce, bancos, saúde</strong> - Criptografia e
              proteção extra
            </Text>
          </Alert>
          ...
          <Alert color="orange" title="APIs públicas">
            <Text size="sm">
              <strong>Rate limiting, CORS, validação</strong> - Proteção contra
              abuso
            </Text>
          </Alert>
          ...
          <Alert color="red" title="Conteúdo gerado por usuários">
            <Text size="sm">
              <strong>Comentários, uploads, UGC</strong> - Sanitização
              obrigatória
            </Text>
          </Alert>
        </Stack>
      ...
      <Paper withBorder p="xl">
        ...
        <Stack gap="xl">
          ...
          <Card withBorder>
            <Title order={3} mb="md">
              {securityExamples.inputValidation.title}
            </Title>
            <Text size="sm" mb="md">
              {securityExamples.inputValidation.description}
            </Text>
            <Stack gap="md">
          ...
          <Card withBorder>
            <Title order={3} mb="md">
              {securityExamples.xssPrevention.title}
            </Title>
            <Text size="sm" mb="md">
              {securityExamples.xssPrevention.description}
            </Text>
            <Stack gap="md">
              <CodeExample
          ...
          <Card withBorder>
            <Title order={3} mb="md">
              {securityExamples.secureStorage.title}
            </Title>
            <Text size="sm" mb="md">
              {securityExamples.secureStorage.description}
            </Text>
            <Stack gap="md">
              <CodeExample
          ...
          <Card withBorder>
            <Title order={3} mb="md">
              {securityExamples.securityHeaders.title}
            </Title>
            <Text size="sm" mb="md">
              {securityExamples.securityHeaders.description}
            </Text>
            <Stack gap="md">
              <CodeExample
          ...
          <Card withBorder>
            <Title order={3} mb="md">
              {securityExamples.rateLimiting.title}
            </Title>
            <Text size="sm" mb="md">
              {securityExamples.rateLimiting.description}
            </Text>
            <Stack gap="md">
              <CodeExample
      ...
      <Paper withBorder p="xl">
        ...
        <Stack gap="md">
          <Alert color="red" title="Over-engineering">
            <Text size="sm">
              <strong>Problema:</strong> Implementar segurança complexa
              desnecessária
            </Text>
            <Text size="sm" mt="xs">
              <strong>Solução:</strong> Comece com o básico. Validação,
              sanitização, HTTPS.
            </Text>
          </Alert>
          ...
          <Alert color="red" title="Security by obscurity">
            ...
            <Text size="sm" mt="xs">
              <strong>Solução:</strong> Dados sensíveis ficam no backend.
              Sempre.
            </Text>
          </Alert>
          ...
          <Alert color="red" title="Trusting client-side validation">
            ...
            <Text size="sm" mt="xs">
              <strong>Solução:</strong> Valide sempre no backend. Front-end é só
              UX.
            </Text>
          </Alert>
          ...
          <Alert color="red" title="Ignoring updates">
            <Text size="sm">
              <strong>Problema:</strong> Não atualizar dependências com
              vulnerabilidades
            </Text>
            <Text size="sm" mt="xs">
      ...
      <Paper withBorder p="xl">
        ...
        <Stack gap="md">
          <Text>
            <strong>Segurança não é opcional.</strong> Mesmo em projetos
          ...
          <Alert color="blue" title="Lembre-se">
            <Text size="sm">
              Segurança é um processo, não um produto. Comece simples e evolua
              conforme necessário.
            </Text>
          </Alert>
        </Stack>
