...
describe('Decision Wizard E2E', () => {
  ...
  describe('Desktop - Fluxos Completos', () => {
    ...
    it('SaaS + Não cresce + Com integrações', () => {
      ...
      cy.contains('Seu projeto vai crescer muito ou terá time grande?', { timeout: 5000 }).parent().contains('Não').click();
      cy.contains('Vai integrar com muitos sistemas?').parent().contains('Sim').click();
  ...
  describe('Performance e UX', () => {
    ...
    it('deve responder rapidamente aos cliques', () => {
      cy.contains('MVP/Protótipo').click();
      cy.contains('Seu projeto vai crescer muito ou terá time grande?', { timeout: 2000 });
